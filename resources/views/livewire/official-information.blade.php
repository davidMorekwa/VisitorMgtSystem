	<div class=" bg-white rounded-3xl w-[45%] mt-24 px-5 py-10">
		...
		<div class="relative">
			<select wire:model="selected_purpose" wire:model.live='selected_purpose'
				wire:change='handleOptionChange' name="purpose" required id="purpose"
		...
		<div class="relative">
			<input id="person_to_visit" name="person_to_visit" type="text"
				...
				wire:model='person_to_visit' wire:change='handleNameInputChange'
