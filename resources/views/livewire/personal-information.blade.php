	<div class="w-[35%] sm:w-full md:w-3/4 rounded-3xl bg-white px-5 pb-0 pt-10">
		...
		<div class="relative">
			<x-input id="ID_number" name="ID_number" type="number"
				class="focus:border-sasra_color peer w-3/4 sm:w-full md:w-[85%] border-b border-gray-300 bg-inherit px-3 py-1 transition-colors focus:border-b-2 focus:outline-none"
		...
		<div class="relative">
			<x-input id="name" name="name" type="text"
				class="focus:border-sasra_color peer w-3/4 sm:w-full md:w-[85%] border-b bg-inherit px-3 py-1 outline-none transition-colors placeholder:text-white focus:border-b-2 focus:outline-none focus:placeholder:text-gray-400"
		...
		<div class="relative">
			<x-input id="phone_number" name="phone_number" type="number" prefix="254"
				class="focus:border-sasra_color peer w-3/4 sm:w-full md:w-[85%] border-b border-gray-300 bg-inherit px-3 py-1 transition-colors placeholder:text-white focus:border-b-2 focus:outline-none focus:placeholder:text-gray-400"
